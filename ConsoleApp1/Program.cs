...
namespace ConsoleApp1
{
    ...
    enum Genre
    {
        Unrated = 0, Action = 1, Romance = 2, Documentary = 4, Mystery = 8, Musical = 16, Horror = 32,
        Comedy = 64, Fantasy = 128, Animation = 256, Adventure = 512
    }
    class Program
    {
        static void Main(string[] args)
        {
            ...
            eglinton.AddShow(new Show(toys4, Day.Sat, 6.40, new Time(14, 10,0)));

            eglinton.AddShow(new Show(godzilla, Day.Mon, 6.89, new Time(13, 55, 0)));
            eglinton.AddShow(new Show(avengers, Day.Sat, 12.25, new Time(21, 5, 0)));
            eglinton.AddShow(new Show(godzilla, Day.Sun, 6.89, new Time(14, 0,0)));
            eglinton.AddShow(new Show(toys4, Day.Sat, 6.40, new Time(14, 10,0)));
            eglinton.AddShow(new Show(avengers, Day.Sat, 12.25, new Time(21, 5, 0)));
            ...
            eglinton.AddShow(new Show(godzilla, Day.Wed, 8.50, new Time(22, 5,0)));
            eglinton.AddShow(new Show(avengers, Day.Tue, 10.75, new Time(20, 30,0)));
            eglinton.AddShow(new Show(godzilla, Day.Thu, 8.50, new Time(20, 15,0)));
            eglinton.AddShow(new Show(avengers, Day.Wed, 10.75, new Time(20, 30,0)));
            eglinton.AddShow(new Show(godzilla, Day.Fri, 8.50, new Time(18, 25,0)));
            eglinton.AddShow(new Show(avengers, Day.Sun, 10.75, new Time(14, 15,0)));
